...
import com.seungho.airquality.databinding.ActivityMapBinding
...
class GoogleMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    //MainActivity에서 전달된 위도/경도

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(binding.root)

        lat = intent.getDoubleExtra("settingLat" , 0.0)
        lng = intent.getDoubleExtra("settingLng" , 0.0)
    ...
    override fun onMapReady(googleMap : GoogleMap) {
        ...
        mMap?.let {
            ...
            it.setMaxZoomPreference(20.0f) //줌 최대값
            it.setMinZoomPreference(12.0f) //줌 최솟값
